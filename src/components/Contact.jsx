          ...
          <div className="w-full lg:w-1/2 bg-blue-500 text-white p-8 rounded-md shadow-md">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <p>+2348034100655, +2349071171137</p>
              </div>

              <div className="flex items-center">
                <FaEnvelope className="text-blue-100 text-2xl mr-4" />
                <p>ikyesega@yahoo.com</p>
              </div>

              <div className="flex items-center">
                <GoLocation className="text-blue-100 text-2xl mr-4" />
                <p>Address: No. 1 Barracks Road Adjacent zoo view, close to St. Theresa's Cath. Church, Jos Plateau State, Nigeria.</p>
              </div>

              <div className="flex items-center">
                <FaTwitter className="text-blue-100 text-2xl mr-4" />
                <p>@ikyesega</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a
                  href="https://wa.me/2348034100655?text=Hello%20I%20would%20like%20to%20make%20an%20inquiry."
                  target="_blank"
